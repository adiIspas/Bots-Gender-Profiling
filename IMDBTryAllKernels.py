...
for pgram in range(1,13):#2 
	for normalizare in [False,True]:
		...
		for kernelFunc in [KernelFrom2ListsK3RN3L,KernelFrom2ListsK3RN3LSQRT,KernelFrom2ListsK3RN3LSqared,KernelFrom2ListsIntersect,KernelFrom2ListsSpectrum,KernelFrom2ListsPresence]:#3
			...
			print(pgram,normalizare,kernelFunc.__name__,AccMax, file=fout)